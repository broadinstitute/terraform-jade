module "k8s-master" {
  ...
  dependencies = [module.enable-services, google_compute_network.network, google_compute_subnetwork.subnetwork, var.dependencies]
...
module "k8s-nodes" {
  ...
  dependencies = [module.enable-services, module.k8s-master, var.dependencies]
